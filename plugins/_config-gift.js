const freeXP = 500;
const premXP = 2000;
const freelimit = 10; // عدد الجواهر التي سيحصل عليها المستخدم في المكافأة اليومية
const premlimit = 50; // عدد الجواهر التي سيحصل عليها المستخدم المميز في المكافأة اليومية
