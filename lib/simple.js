	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363316591980991@newsletter',
            newsletterName: 'MAJNON-WA 💫', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363316591980991@newsletter", "120363316591980991@newsletter", "120363316591980991@newsletter", "120363316591980991@newsletter"]
